...
static int aw8697_haptic_set_gain(struct aw8697 *aw8697, unsigned char gain)
{
    aw8697_i2c_write(aw8697,
            AW8697_REG_DATDBG,
            aw8697_haptic_set_level(aw8697,
            aw8697->gain_override ? 0x80 : gain));
...
static ssize_t aw8697_gain_override_show(struct device *dev,
        struct device_attribute *attr, char *buf)
{
#ifdef TIMED_OUTPUT
    struct timed_output_dev *to_dev = dev_get_drvdata(dev);
    ...
    return snprintf(buf, PAGE_SIZE, "%d\n", aw8697->gain_override);
}

static ssize_t aw8697_gain_override_store(struct device *dev,
        struct device_attribute *attr, const char *buf, size_t count)
{
#ifdef TIMED_OUTPUT
    struct timed_output_dev *to_dev = dev_get_drvdata(dev);
...
static DEVICE_ATTR(gain_override, S_IWUSR | S_IRUGO, aw8697_gain_override_show, aw8697_gain_override_store);
